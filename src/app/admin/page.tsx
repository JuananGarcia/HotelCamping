...
export default function AdminDashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12 space-y-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-zinc-900 tracking-tight">Panel de Administración</h1>
        <p className="text-zinc-500 mt-2">Gestiona tus unidades, reservas y disponibilidad.</p>
      </div>
