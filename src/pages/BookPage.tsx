...
import { ChevronLeft, Calendar, Users, ShieldCheck, CreditCard, Info } from 'lucide-react';
...
export const BookPage = () => {
  ...
  // Extract URL params (Simulating Next.js useSearchParams)
  ...
  const imageUrl = unit.type === 'cabana'
            ...
            <div>
              <div className="flex items-center gap-3 mb-2">
                <span className="px-3 py-1 bg-zinc-100 text-zinc-600 text-xs font-bold uppercase tracking-wider rounded-full">
                  {unit.type === 'cabana' ? 'Cabaña' : 'Parcela'}
                </span>
